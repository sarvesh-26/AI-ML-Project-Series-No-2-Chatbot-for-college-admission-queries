...
# import data_preprocessing                                   #(nlp library usesed for preprocessing)
...
from data_preprocessing import *     #import data_preprocessing function from data_preprocessing.py
training, output, labels, words, data = data_preprocessing(stemmer=stemmer)
...
X_train, X_test, y_train,y_test = train_test_split(training,output,test_size=0.3)
#
