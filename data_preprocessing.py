...
#         print("yha tak")                                        #example intent (anyone there?) the root of there? is "there" and whats up will be what
...
def data_preprocessing(stemmer):
    ...
    try:
        with open("data.pickle", "rb") as f:
            words, labels, training, output = pickle.load(f)
    except FileNotFoundError:  # Add FileNotFoundError exception
        words = []
        labels = []
        docs_x = []
        docs_y = []
